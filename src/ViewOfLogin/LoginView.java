...
import ModelOfLogin.*;
import ControllerOfLogin.*;
import java.awt.event.ActionListener;
import viewofregistration.RegistrationView;
/**
 *
 * @author anukul
 */
...
public class LoginView extends javax.swing.JFrame {
 LoginModel logMod;
    ...
    private void initComponents() {
        ...
        registerButton.setBounds(800, 540, 130, 50);
...
public LoginModel getUser(){
    logMod=new LoginModel(emailText.getText(),passwordText.getText());  
    return logMod;
}
